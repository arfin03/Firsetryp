...
from shivu import application, sudo_users, collection, destination_db, CHARA_CHANNEL_ID, SUPPORT_CHAT
...
async def upload(update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        rarity_map = {1: "⚪ Common", 2: "🟣 Rare", 3: "🟡 Legendary", 4: "🟢 Medium", 5: "💮 Special edition", 6: "🔮 Limited Edition", 7: "💸 Premium Edition"} 
        try:
